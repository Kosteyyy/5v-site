export const ymapsInitData = {
  vectorVersion: "5.21.0",
  vectorVersionTimestamp: 1662887288911,
  flags: [],
  server: {
    url: "https://api-maps.yandex.ru/2.1.79",
    path: "build/release",
    params: {
      apikey: "8539c825-fd7a-4501-a047-b534f491f00c",
      mode: "release",
      ns: "ymaps",
      csp: null,
    },
  ...
  layers: {
    map: {
      version: "22.09.09-0-b220819125430",
      scaled: true,
    ...
    sat: { version: "3.1028.0" },
    sta: { version: "2022.09.11.01.24-1_22.09.09-1-12362" },
    trf: { version: "1662887280", scaled: true },
    stv: { version: "2022.09.11.01.24-1_22.09.09-1-12362" },
  ...
  token: "08c178dfc9a45bb5d3923c8c2a9fdd25",
  distribution: {},
  version: "2.1.79",
  majorVersion: "2.1",
  ...
  bundles: {
    panoramas: "/release/panoramas-a0ea1644980a501f6c2e49da1c69fcbabdd9f41e.js",
    full: "/release/full-9eff090185fae9790f8b655ceb717a6c63ca53f5.js",
    PREFIX: "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-42/build",
  },
};

export function ymapsInit(e) {
  var n = this,
    t = { ns: {}, supports: {}, env: e };
  (t.performance = {
    now:
  ...
  (t.modules = new o({
    ...
    fetchBundle: function (e) {
      ...
      (o.src = t.env.hosts["static"] + t.env.bundles.PREFIX + t.env.bundles[e]),
